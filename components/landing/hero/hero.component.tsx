...
export default function HeroSection() {
  return (
    <section className="overflow-hidden pb-12 lg:pt-[0px] lg:pb-[90px]">
      <div className="container mx-auto">
        <div className="flex flex-wrap md:flex-row items-center justify-center gap-5 lg:gap-14 lg:-mx-4">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="right-to-center">
              <div
                className={cn(
                  "group w-11/12 lg:w-8/12 rounded-full border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-indigo-800"
                )}
              >
                <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                  <span className="text-sm lg:text-base font-bold text-wrap">
                    ✨Official Clothing Line for GenZ ✨
                  </span>
                </AnimatedShinyText>
              </div>
              ...
              <div className="flex flex-col gap-4 justify-center items-center text-center lg:text-left lg:items-start">
                <h2 className="right-to-center mb-5 tracking-widest	 text-2xl md:text-4xl lg:text-5xl lg:font-extralight lg:text-wrap font-bold text-zinc-900 dark:text-gray-100 sm:text-[40px]/[48px]">
                  ...
                  <span className="text-indigo-900  dark:text-indigo-500 font-extrabold">
